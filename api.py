...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        JSON с уникальным ключом пользователя с указанным email и паролем"""
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет (постит) на сервер фото к ранее добавленному питомцу и возвращает статус
        запроса на сервер и результат в формате JSON с данными питомца, которому в профиль добавили фото."""
